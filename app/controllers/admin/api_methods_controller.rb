class Admin::ApiMethodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @api_method.save
        format.html { redirect_to admin_api_version_api_method_path(@api_version, @api_method), flash: {success:  t('app.msgs.success_created', :obj => t('mongoid.models.api_method.one'))} }
  ...
  def update
    ...
    respond_to do |format|
      if @api_method.update_attributes(params[:api_method])
        format.html { redirect_to admin_api_version_api_method_path(@api_version, @api_method), flash: {success:  t('app.msgs.success_updated', :obj => t('mongoid.models.api_method.one'))} }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_api_versions_url, flash: {success:  t('app.msgs.success_deleted', :obj => t('mongoid.models.api_method.one'))} }
      format.json { head :no_content }
    end
  end
