...
PageContent.create(name: 'instructions', title: 'Instructions', content: '<div class="header">UNICEF Georgia is putting its data at your fingertips. You may interact with the data in both Georgian and English languages in the following ways:</div>
<div class="box"><div class="title datasets">Datasets</div>
...
<div class="box"><div class="title time-series">Time Series</div>
...
<p>Just as when you download the data, you\'ll need to create an account to use the API. Once you create an account, you\'ll have access to your API key, which is required to use the API. For more information about the API, please visit our API page.</p></div>') if PageContent.by_name('instructions').nil?
