...
PageContent.create(name: 'instructions', title: 'Instructions', content: '<div class="header"><a href="http://www.unicef.ge" target="_blank">UNICEF Georgia</a> is putting its data at your fingertips. You may interact with the data in both Georgian and English languages in the following ways:</div>
<div class="box"><div class="caption"><div class="i datasets"></div><div class="title">Datasets</div><div class="line"></div></div>
<div class="text"><p>To see a listing of all the datasets available, check out the dataset index. Here you can search by keywords or by category to find what you are looking for whether it be a lone dataset or time series data. From here you can launch into each dataset\'s dashboard page to learn more and further explore the data.</p>
<p>The dashboard provides a wealth of contextual information about each dataset, including its metadata, data highlights, its methodology, codebook, licensing, and relevant reports. Search for interesting questions using the codebook\'s search feature and click on the question\'s code to explore and visualize it. It\'s that easy.</p></div></div>
<div class="box"><div class="caption"><div class="i explore-data"></div><div class="title">Explore Data</div><div class="line"></div></div>
<div class="text"><p>You don\'t need to be a statistician to explore UNICEF Georgia\'s data. While it is possible to download the raw data for more advanced analysis, here you can easily explore and visualize a single question or the relationship between two questions by comparing them. You can even filter the results by a third question.</p>
<p>To help you make sense of the numbers, single variables are visualized in pie charts, tables, and possibly maps if relevant. Comparing two questions gives a bar chart, a table, and if possible a map. You can export the charts and graphs in a variety of formats (png, jpeg, pdf, svg) depending on your needs. You can also embed the visuals into other web pages using the widgets. For you developers out there, you can even access data in JSON format using the API.</p></div></div>
<div class="box"><div class="caption"><div class="i time-series"></div><div class="title">Time Series</div><div class="line"></div></div>
<div class="text"><p>UNICEF Georgia sometimes asks people the same questions at regular time intervals to see how attitudes and opinions change over time such as in the case of the Welfare Monitoring Survey. Time series data is visualized using line charts to make it easy to understand how responses to a question change over time. Like individual datasets, you can export the graphs, embed them in other web pages, and access the data in JSON format using the API.</p></div></div>
<div class="box"><div class="caption"><div class="i download-data"></div><div class="title">Download Data</div><div class="line"></div></div>
<div class="text"><p>UNICEF Georgia enables you to download the raw data and codebook of any of its datasets. You are required to provide some basic information about yourself, but if you\'d like to avoid this each time you download a dataset, go ahead and create an account on this site. In addition, with an account, you can opt in to receive notifications when new datasets are added.</p></div></div>
<div class="box"><div class="caption"><div class="i api"></div><div class="title">API</div><div class="line"></div></div>
<div class="text"><p>While it is possible to download the datasets, you are welcome access the data in JSON format using the API to create your own interactive applications or visualizations. This is most relevant for time series data that can be updated in the future with additional sets of data. By using the API, you can ensure that when a new dataset is added, your application can automatically adjust based on the new data.</p>
<p>Just as when you download the data, you\'ll need to create an account to use the API. Once you create an account, you\'ll have access to your API key, which is required to use the API. For more information about the API, please visit our API page.</p></div></div>') if PageContent.by_name('instructions').nil?
