...
<p>There are no optional parameters for this call.</p>
<h2>What You Get</h2>
<p>The return object is a JSON object&nbsp;of dataset information&nbsp;with the following information:</p>
<table class="table table-bordered table-hover table-nonfluid">
<thead>
<tr><th>Parameter</th><th>Description</th></tr>
</thead>
...
<tr>
<td>description</td>
<td>A description of the dataset, may include html&nbsp;markup</td>
</tr>
<tr>
<td>start_gathered_at</td>
<td>Date the data gathering process started, format: yyyy-mm-dd (e.g., 2015-01-31)</td>
...
<td>The&nbsp;language that is used by default</td>
</tr>
<tr>
<td>methodology</td>
<td>The&nbsp;method in which the data was collected, may include html&nbsp;markup</td>
</tr>
</tbody>
</table>
<h2>Examples</h2>
...
<tr>
<td>code</td>
<td>Code of the question. You&nbsp;will use this value&nbsp;to run an analysis.</td>
</tr>
<tr>
<td>original_code</td>
...
<tr>
<td>description</td>
<td>A description of the time series, may include html&nbsp;markup</td>
</tr>
<tr>
<td>public_at</td>
<td>Date the data was made public on this site, format: yyyy-mm-dd (e.g., 2015-01-31)</td>
