...
module BootstrapStarter
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( bootstrap-select.min.js highcharts.js highcharts-map.js highcharts-exporting.js masonry.pkgd.min.js select2/select2.min.js shBrushJScript.js shCore.js tinymce/*)    
