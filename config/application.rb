...
module BootstrapStarter
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( datasets.js explore_data.js explore_time_series.js exclude_answers.js exclude_questions.js mappable_form.js questions.js search.js tabbed_translation_form.js )    
    config.assets.precompile += %w( datasets.css explore_data.css explore_time_series.css exclude_answers.css exclude_questions.css mappable_form.css questions.css tabbed_translation_form.css time_series.css)    
